...
//       axios.post(`${import.meta.env.VITE_PORT}/api/addProject`, {
//         title: name,
...
//       {
//         loading: "Saving...",
//         success: <b>Project added successfully</b>,
//         error: <b>Could not add project</b>,
//       }
//     );

//     // Clear the form only if the above succeeds
//     setname("");
//     setDescription("");
//     setImage(null);
//     setGithubLink("");
...
// };
  ...
  try {
    await toast.promise(
      (async () => {
        // Upload image
        const uploaded = await uploadImg(image);
        if (!uploaded) throw new Error("Image upload failed");

        // Save project
        await axios.post(`${import.meta.env.VITE_PORT}/api/addProject`, {
          title: name,
          description: description,
          githubUrl: githubLink,
          liveUrl: liveLink,
          ...
          deleteToken: uploaded.deleteTokent,
          id: userId,
        });
  ...
  return (
    ...
    <div className="lg:w-[30%] w-[90%] lg:mt-0 mt-20 h-fit flex flex-col">
      <h1 className="lg:text-5xl gradient-text lg:font-bold flex justify-center mx-auto text-3xl text-gray-300 mb-3">
        Create Project
      </h1>
      {/* lg:p-4 flex flex-col lg:w-[30%] w-[90vw] lg:gap-2 */}
      <form
        onSubmit={addProject}
        className="flex lg:p-3 p-6 flex-col lg:mx-3  backdrop-blur-3xl rounded-lg lg:gap-3"
      >
