...
function PortfolioCard() {
  ...
  return (
    ...
    data-aos-duration="2000"
        className='portfolio-card border-2 hover:scale-110 will-change-transform transition-all delay-100 hover:border-white backdrop-blur-md select-none border-gray-500 rounded-xl text-white lg:p-5 mb-20 lg:mb-44 px-5 lg:w-[30vw] w-[80vw] shadow-lg duration-300'
    >
