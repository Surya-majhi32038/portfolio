...
function ProjectCard({project}) {
  return (
    ...
    <div className='lg:h-fit h-[440px]  select-none lg:w-[300px] w-[270px]  flex flex-col overflow-hidden border-opacity-60 hover:shadow-lg hover:lg:scale-110 cursor-grab hover:border-4 hover:border-gray-400 transition-all hover:z-10 z-0 delay-100 duration-300 rounded-2xl gap-3 lg:gap-1 border-2 border-gray-400 backdrop-blur-xl'>
