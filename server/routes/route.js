...
const { getUser, authUser,updatePersonalDetails, getPersonalDetails } = require('../controllers/user.controller.js');
...
const { deleteImg } = require('../cloudinary/deleteImg.js');
...
router.get("/get-personal-details/:userId",getPersonalDetails); // Update personal details with token verification
...
// cloudinary routes
router.delete('/deleteImg',deleteImg);
